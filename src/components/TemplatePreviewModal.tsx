  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col">
        {/* Header */}
        <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between bg-gradient-to-r from-gray-600 to-gray-700 text-white">
          <div>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-900 mb-2">{sample.sampleInput.description}</p>
          ...
          <div>
            ...
            <p className="text-sm text-gray-900 mb-2">{sample.expectedOutput.description}</p>
